    ...
    public class UserActivityHook
    {
        ...
        public void Start(bool InstallMouseHook, bool InstallKeyboardHook)
        {
            ...
            if (hMouseHook == 0 && InstallMouseHook)
            {
                ...
                //install hook
                hMouseHook = SetWindowsHookEx(WH_MOUSE_LL, MouseHookProcedure, Marshal.GetIDispatchForObject(Assembly.GetExecutingAssembly().GetModules()[0]), 0);
            ...
            if (hKeyboardHook == 0 && InstallKeyboardHook)
            {
                ...
                //install hook
                hKeyboardHook = SetWindowsHookEx(WH_KEYBOARD_LL, KeyboardHookProcedure, Marshal.GetIDispatchForObject(Assembly.GetExecutingAssembly().GetModules()[0]), 0);
                //If SetWindowsHookEx fails.
                if (hKeyboardHook == 0)
                {
                    //Returns the error code returned by the last unmanaged function called using platform invoke that has the DllImportAttribute.SetLastError flag set. 
